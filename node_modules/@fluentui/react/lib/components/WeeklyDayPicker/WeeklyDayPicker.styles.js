    ...
    return {
        ...
        navigationIconButton: [
            getFocusStyle(theme, { inset: 0 }),
            {
                ...
                fontFamily: 'inherit',
                selectors: (_a = {},
                    _a[".".concat(classNames.root, ":hover &, .").concat(IsFocusVisibleClassName, " .").concat(classNames.root, ":focus &, ") +
                        ".".concat(IsFocusVisibleClassName, " &:focus")] = {
                        height: 53,
                        minHeight: 12,
                        overflow: 'initial',
                    },
                    _a[".".concat(IsFocusVisibleClassName, " .").concat(classNames.root, ":focus-within &")] = {
