...
var SparklineBase = /** @class */ (function (_super) {
    ...
    SparklineBase.prototype.componentDidMount = function () {
        ...
        if (!this._isChartEmpty()) {
            ...
            /* eslint-disable @typescript-eslint/no-explicit-any */
            var _a = (0, d3_array_1.extent)(points, function (d) { return d.x; }), xMin = _a[0], xMax = _a[1];
            this.x = (0, d3_scale_1.scaleLinear)()
                .domain([xMin, xMax])
                .range([this.margin.left, this.state._width - this.margin.right]);
            this.y = (0, d3_scale_1.scaleLinear)()
                /* eslint-disable @typescript-eslint/no-explicit-any */
                .domain([0, (0, d3_array_1.max)(points, function (d) { return d.y; })])
    ...
    SparklineBase.prototype.drawSparkline = function () {
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement("path", { className: "area", d: this.area(this.state._points), opacity: 1, fillOpacity: 0.2, fill: this.props.data.lineChartData[0].color, "aria-label": "Sparkline with label ".concat(this.props.data.lineChartData[0].legend) })));
    };
    SparklineBase.prototype.render = function () {
        var classNames = getClassNames(this.props.styles, {
            theme: this.props.theme,
        });
        return !this._isChartEmpty() ? (React.createElement(react_focus_1.FocusZone, { direction: react_focus_1.FocusZoneDirection.horizontal, isCircularNavigation: true, className: classNames.inlineBlock },
