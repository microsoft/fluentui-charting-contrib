...
json_file_path = r".\extracted_executed_code.json"
output_json_file_path = r".\extracted_code_snippets.json"
        ...
        for key, value in obj.items():
            if key == 'result':
                try:
                    ...
                    if 'executedCode' in result_data:
                        extracted.append(result_data['executedCode'])
