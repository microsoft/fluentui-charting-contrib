...
gantt_json_schema = json.dumps(fig_gantt.to_plotly_json(), indent=4)
...
line_json_schema = json.dumps(fig_line.to_plotly_json(), indent=4)
...
pie_json_schema = json.dumps(fig_pie.to_plotly_json(), indent=4)
