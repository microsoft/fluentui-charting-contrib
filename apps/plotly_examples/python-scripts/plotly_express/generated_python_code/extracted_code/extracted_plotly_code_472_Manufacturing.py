...
fig1_json = json.dumps(fig1.to_plotly_json(), cls=PlotlyJSONEncoder)
...
fig2_json = json.dumps(fig2.to_plotly_json(), cls=PlotlyJSONEncoder)
...
fig3_json = json.dumps(fig3.to_plotly_json(), cls=PlotlyJSONEncoder)

# Save JSON schemas to file
with open('chart_schemas.json', 'w') as f:
    json.dump({'histogram_defect_rate': fig1_json, 'pareto_defect_types': fig2_json, 'line_defect_rate_trends': fig3_json}, f, cls=PlotlyJSONEncoder)