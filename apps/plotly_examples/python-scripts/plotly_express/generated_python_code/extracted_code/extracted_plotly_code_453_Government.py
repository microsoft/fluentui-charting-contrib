...
# Convert the relevant part of the data dictionary into a Pandas DataFrame
df = pd.DataFrame({
    "date": data["date"],
...
fig2 = px.bar(df, x="date", y=["positive_sentiment", "negative_sentiment", "neutral_sentiment"], title="Sentiment Analysis Over Time", labels={'value': 'Sentiment Count', 'date': 'Date'}, barmode='group')
