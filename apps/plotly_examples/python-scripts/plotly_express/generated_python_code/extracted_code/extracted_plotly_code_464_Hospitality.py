...
data = {
    ...
    'room_number': ['R'+str(i) for i in range(101, 116)],  # Truncate to 15 elements
    'check_in_time': [15 + i % 5 for i in range(15)],  # Truncate to 15 elements
    'check_out_time': [11 + i % 4 for i in range(15)],  # Truncate to 15 elements
    'turnover_rate': [2 + i % 2 for i in range(15)],  # Truncate to 15 elements
    'maintenance_requests': [i % 5 for i in range(15)],  # Truncate to 15 elements
    'resolution_time': [30 + i % 15 for i in range(15)]  # Truncate to 15 elements
}
