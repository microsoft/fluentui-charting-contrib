...
data = {
    ...
    'department': (['HR', 'Finance', 'DevOps', 'Sales', 'Marketing'] * 3)[:12],  # Repeat and truncate to 12 elements
    'resource_type': (['CPU', 'Memory', 'Storage'] * 4)[:12],  # Repeat and truncate to 12 elements
