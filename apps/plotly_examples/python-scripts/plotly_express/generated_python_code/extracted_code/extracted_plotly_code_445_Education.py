...
# Group by "Subject_Taught" and calculate the mean for numeric columns only
average_performance_by_subject = df.groupby("Subject_Taught", as_index=False)[
    ["Performance_Score", "Training_Sessions_Attended", "Peer_Evaluation_Score", "Experience_Years"]
].mean()

# Create the bar chart
fig2 = px.bar(
    average_performance_by_subject,
    x="Subject_Taught",
    y="Performance_Score",
