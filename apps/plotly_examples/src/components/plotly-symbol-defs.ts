...
export const symbols = {
    circle: {
        n: 0,
        f: function(r: number, angle: any, standoff: any) {
...
function skipAngle(angle: null) {
    return angle === null;
}

var lastPathIn: any, lastPathOut: string;
var lastAngle: any, lastStandoff: any;

function align(angle: number, standoff: any, path: string) {
    ...
    function rotate(t: number, xy: any[]) {
        var cosT = cos(t);
        var sinT = sin(t);
